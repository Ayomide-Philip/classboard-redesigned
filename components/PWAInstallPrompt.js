  ...
  return (
    <>
      {isInstallButtonVisible && (
        <div className="fixed bottom-0 isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
          <div
            aria-hidden="true"
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p className="text-sm/6 text-gray-900">
              ...
              The Classora web application for better experience
            </p>
            <button
              id="install-button"

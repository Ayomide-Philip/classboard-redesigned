                ...
                <div className="flex flex-col md:flex-row items-center gap-16">
                    <div className="md:w-1/2">
                        ...
                        <p className="text-lg text-muted-foreground mb-8">
                            Classora isn't just a tool; it's the infrastructure for a better
                            academic life. We've thought of everything so you don't have to.
                        </p>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <EcosystemItem
                                ...
                                desc="Automated nudges for assignments and exams."
                            />
                            <EcosystemItem
                            ...
                            <EcosystemItem
                                ...
                                desc="Find faculty and student contacts securely."
                            />
                            <EcosystemItem
                                icon={<ShoppingBag className="w-5 h-5 text-pink-500" />}
                                title="Marketplace (Beta)"
                                desc="Buy/sell textbooks within your campus."
                            />
                        </div>
                    </div>

        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col items-center text-center gap-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              The all-in-one ecosystem for students and educators. Manage classes, 
              engage communities, and find venues—all in one beautiful interface.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Classora brings together all the tools you need to manage your educational journey effectively.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 p-8 md:p-16 text-center text-white overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto">
                Join thousands of students and educators who are already using Classora to teach more and manage less.
              </p>
              <Link 
                href="/auth/register" 
      ...
      <footer className="border-t border-border py-12 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-6 h-6 rounded bg-indigo-600 flex items-center justify-center text-white text-xs font-bold">C</div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border/50 text-sm text-muted-foreground">
            <p>© 2024 Classora Inc. All rights reserved.</p>
